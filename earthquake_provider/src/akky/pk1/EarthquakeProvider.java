...
public class EarthquakeProvider extends ContentProvider {
  ...
  public static final Uri CONTENT_URI = Uri.parse("content://akky.pk1/earthquakes");
  ...
  static {
   ...
   uriMatcher.addURI("akky.pk1", "earthquakes", QUAKES);
   uriMatcher.addURI("akky.pk1", "earthquakes/#", QUAKE_ID);
  }
